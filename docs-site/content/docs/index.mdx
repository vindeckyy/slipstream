...
<Cards>
  ...
  <Card title="Desktop at work" href="/docs/virtual-displays" description="Workstation and Hot-desk presets, keep-alive, and per-client displays for remote desktop work." />
