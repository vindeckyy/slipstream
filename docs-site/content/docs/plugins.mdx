...
[`slipstream-plugin-index`](https://github.com/vindeckyy/slipstream.git-plugin-index) — its README covers the
...
[the plugin's repo](https://github.com/vindeckyy/slipstream.git-plugin-virtualhere).
...
it. Start from the
[plugin-kit README](https://github.com/vindeckyy/slipstream.git/src/branch/main/plugin-kit) and
[ROM Manager](https://github.com/vindeckyy/slipstream.git-plugin-rom-manager), which is the reference
