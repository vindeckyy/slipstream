...
[`slipstream-plugin-index`](https://github.com/vindeckyy/slipstream/slipstream-plugin-index) — its README covers the
...
[the plugin's repo](https://github.com/vindeckyy/slipstream/slipstream-plugin-rom-manager).
...
2. **The Slipstream Sync extension** (in Playnite) — download `slipstream-sync.pext` from the
   [plugin's builds](https://github.com/vindeckyy/slipstream/slipstream-plugin-playnite/actions) and **double-click
...
[the plugin's repo](https://github.com/vindeckyy/slipstream/slipstream-plugin-playnite).
...
[the plugin's repo](https://github.com/vindeckyy/slipstream/slipstream-plugin-virtualhere).
...
it. Start from the
[plugin-kit README](https://github.com/vindeckyy/slipstream/slipstream/src/branch/main/plugin-kit) and
[ROM Manager](https://github.com/vindeckyy/slipstream/slipstream-plugin-rom-manager), which is the reference
