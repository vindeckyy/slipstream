...
const fixtureEntries: LogEntry[] = [
	entry(
		...
		"INFO",
		"slipstream_host",
		"slipstream-host 0.4.2 (slipstream_core ABI v2)",
	),
	entry(
		2,
		"INFO",
		"slipstream_host::mgmt",
		"management API listening over HTTPS addr=0.0.0.0:47990",
	),
	entry(
		3,
		"DEBUG",
		"slipstream_host::discovery",
		"mDNS advertise _slipstream._udp pair=required",
	),
	entry(
		4,
		"INFO",
		"slipstream_host::slipstream1",
