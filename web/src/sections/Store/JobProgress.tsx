	...
	return (
		<Card
			className={cn(
				...
				done && "ring-1 ring-[var(--success)]/40",
				running && "ring-1 ring-accent/50",
			)}
			aria-live="polite"
		>
			<CardContent className="space-y-3 p-card pt-card sm:pt-card">
				...
				{done && (
					<p className="flex items-center gap-2 rounded-md bg-muted/40 px-2.5 py-1.5 text-xs text-muted-foreground">
