...
The video itself is the native GTK4 Linux client (the `io.slipstream.Slipstream` flatpak); the plugin
...
You need **[Decky Loader](https://decky.xyz/)** and the **`io.slipstream.Slipstream` flatpak**
