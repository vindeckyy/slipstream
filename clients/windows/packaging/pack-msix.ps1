...
$required = @('slipstream-client.exe', 'slipstream-session.exe', 'slipstream-console.exe', 'slipstream.exe', 'Microsoft.WindowsAppRuntime.Bootstrap.dll', 'SDL3.dll', 'resources.pri')
