//! `slipstream-probe` — the reference client for `slipstream/1` (M3): QUIC control plane, UDP data
...
//!
//! Usage: `slipstream-probe [--connect HOST:PORT] [--mode WxHxFPS] [--out FILE] [--input-test]
