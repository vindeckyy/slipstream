...
export type AudioVideoConfig = { readonly "capture_method"?: string | null, readonly "compositor"?: string | null, readonly "four_four_four"?: boolean, readonly "gamescope_hdr"?: boolean, readonly "headless_compositor"?: string | null, readonly "max_fps"?: number | null, readonly "ten_bit"?: boolean, readonly "video_source"?: string | null }
export const AudioVideoConfig = Schema.Struct({ "capture_method": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Desktop capture backend (`SLIPSTREAM_CAPTURE_METHOD`):\n`auto` | `portal` | `kwin` | `wlr` | `kms` | `x11` | `nvfbc` (no hermes-kms)." })), "compositor": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Virtual-display compositor preference (`SLIPSTREAM_COMPOSITOR`):\n`kwin` | `mutter` | `wlroots` | `hyprland` | `gamescope`." })), "four_four_four": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Prefer 4:4:4 when supported (`SLIPSTREAM_444`)." })), "gamescope_hdr": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Gamescope HDR." })), "headless_compositor": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Headless session spawner (`SLIPSTREAM_HEADLESS_COMPOSITOR`):\n`off` | `auto` | `labwc` | `krfb` | `gamescope`." })), "max_fps": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })), Schema.Null]).annotate({ "description": "Cap encode FPS (`SLIPSTREAM_MAX_FPS`).", "format": "int32" })), "ten_bit": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Prefer 10-bit encode when the client asks (`SLIPSTREAM_TEN_BIT`)." })), "video_source": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "`virtual` | `portal` (`SLIPSTREAM_VIDEO_SOURCE`)." })) }).annotate({ "identifier": "AudioVideoConfig" })
...
export const HostFacts = Schema.Struct({ "platform": Schema.String.annotate({ "description": "`linux` / `windows` / `macos`." }), "version": Schema.String }).annotate({ "description": "Facts about this host, so the console can grey out rows it can't install.", "identifier": "HostFacts" })
...
export type InputConfig = { readonly "gamepad"?: string | null, readonly "gamescope_grab_cursor"?: boolean }
export const InputConfig = Schema.Struct({ "gamepad": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "Gamepad backend preference (`SLIPSTREAM_GAMEPAD`)." })), "gamescope_grab_cursor": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Gamescope: grab cursor into the nested session." })) }).annotate({ "identifier": "InputConfig" })
...
export const Objects_ = Schema.Struct({ "mode": Schema.Literal("off") }).annotate({ "description": "Tear the display down at session end (today's default on every backend but Windows, which\nlingers 10 s)." })
...
export type NetworkConfig = { readonly "chacha20"?: boolean, readonly "fec_pct"?: number | null, readonly "mdns"?: boolean }
export const NetworkConfig = Schema.Struct({ "chacha20": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Prefer ChaCha20-Poly1305 for soft-AES clients (`SLIPSTREAM_CHACHA20`)." })), "fec_pct": Schema.optionalKey(Schema.Union([Schema.Number.check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })), Schema.Null]).annotate({ "description": "FEC percentage for the native plane (`SLIPSTREAM_FEC_PCT`), when set.", "format": "int32" })), "mdns": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Advertise over mDNS (`SLIPSTREAM_MDNS`). Default on." })) }).annotate({ "identifier": "NetworkConfig" })
...
export const UpdateResultInfo = Schema.Struct({ "error": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null])), "finished_unix": Schema.Number.annotate({ "format": "int64" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" })), "from": Schema.String, "log_path": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "The installer's own log file on this host, for diagnosis." })), "ok": Schema.Boolean, "stage": Schema.optionalKey(Schema.Union([Schema.String, Schema.Null]).annotate({ "description": "The stage that failed; absent on success." })), "staged": Schema.optionalKey(Schema.Boolean.annotate({ "description": "Applied but activates on the next reboot (rpm-ostree)." })), "to": Schema.String }).annotate({ "description": "Durable outcome of the most recent apply attempt (survives the host's own restart).", "identifier": "UpdateResultInfo" })
...
export type HostConfigFile = { readonly "audio_video"?: AudioVideoConfig, readonly "encoders"?: EncoderConfig, readonly "general"?: GeneralConfig, readonly "input"?: InputConfig, readonly "network"?: NetworkConfig, readonly "version"?: number }
export const HostConfigFile = Schema.Struct({ "audio_video": Schema.optionalKey(AudioVideoConfig), "encoders": Schema.optionalKey(EncoderConfig), "general": Schema.optionalKey(GeneralConfig), "input": Schema.optionalKey(InputConfig), "network": Schema.optionalKey(NetworkConfig), "version": Schema.optionalKey(Schema.Number.annotate({ "format": "int32" }).check(Schema.isInt().annotate({ "expected": "an integer" })).check(Schema.isGreaterThanOrEqualTo(0).annotate({ "expected": "a value greater than or equal to 0" }))) }).annotate({ "description": "Sunshine-shaped host settings the console can toggle without editing env files by hand.", "identifier": "HostConfigFile" })
