...
- **Nothing changed on the wire or at the API boundary.** Streaming protocol stays at version **2**, and the embeddable C ABI stays at **13** — 0.18–0.20 hosts and clients keep mixing freely.
