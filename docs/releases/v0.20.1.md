...
- **The package source instructions were incomplete.** `winget install vindeckyy.SlipstreamHost` says "no package found" until you've pointed winget at Slipstream's own source, once per machine — the command for that is now spelled out.
