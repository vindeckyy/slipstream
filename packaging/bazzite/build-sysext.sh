...
#
# Usage:
#   bash build-sysext.sh --version-id 43 --out dist/slipstream-0.24.0-1-x86-64.raw \
#        [--gamescope path/to/slipstream-gamescope] \
#        dist/slipstream-0.24.0-1.fc43.x86_64.rpm dist/slipstream-web-0.24.0-1.fc43.x86_64.rpm
#
