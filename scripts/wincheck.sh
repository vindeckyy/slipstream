#!/usr/bin/env bash
#
# Type-check and lint slipstream's WINDOWS-only Rust from a Linux dev box.
#
...
//! GENERATED by scripts/wincheck.sh — a STUB of slipstream-core carrying only the two items the
