...
impl HostConfigFile {
    ...
    pub fn to_host_env(&self) -> String {
        let mut out = String::from("# Generated by slipstream-host from host-config.json. Edit via the web console.\n");
        ...
        set_bool(&mut out, "SLIPSTREAM_GAMESCOPE_HDR", self.audio_video.gamescope_hdr);
